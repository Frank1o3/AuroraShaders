...
// =====================================================================
// Aurora Shaders - gbuffers_basic.fsh
// Particles, fire, basic textured quads.
// =====================================================================
...
void main() {
    ...
    // Particles face camera; default normal points at viewer.
    outAlbedo   = vec4(albedo, texColor.a);
    outNormal   = vec4(0.5, 0.5, 1.0, MAT_DEFAULT / 255.0);
